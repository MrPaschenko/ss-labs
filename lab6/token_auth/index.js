...
app.get('/login', async (req, res) => {
    res.redirect(`https://dev-c0ba8hehzswou2jj.eu.auth0.com/authorize?response_type=code&client_id=NmknH1Rym8Bt2wIgf2G1PkCK5aFIu3KM&redirect_uri=http://localhost:3000&scope=offline_access&audience=https://dev-c0ba8hehzswou2jj.eu.auth0.com/api/v2/&state=login-example-${uuid.v4()}`)
});
